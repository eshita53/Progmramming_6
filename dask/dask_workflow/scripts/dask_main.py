...
def main():
    ...
    y_encoded = dd.from_array(encoder.fit_transform(y),columns=['classes']).classes
    logger.info("Target class Encoded")
        
    train_X, test_X, train_y, test_y = train_test_split(dataset, y_encoded, test_size=0.2, random_state=42, shuffle=False)
